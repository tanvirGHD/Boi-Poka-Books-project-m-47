...
const NavBar = () => {
  ...
  <div className="navbar-end gap-5">
    <a className="btn bg-green-500 text-white hover:bg-green-500 hover:text-white">Sign In</a>
    <a className="btn  bg-green-500 text-white hover:bg-green-500 hover:text-white">Sign Up</a>
  </div>
</div>
  );
};
